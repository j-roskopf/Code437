...
class DeckPersistenceTest {
    ...
    fun loadDeckPersistence_restoresCharacterDecksAndSelection() {
        ...
        try {
            ...
            assertTrue(GameState.characterDeckCards(PlayerCharacter.MAGE).contains(PlayerDeckCard.KEY_BRONZE))
            ...
            assertTrue(round.contains("cd_MAGE=POTION,KEY_BRONZE"), "Persist should include mage deck: $round")
    ...
    fun loadDeckPersistence_mapsLegacyKeyTokenToBronzeKeyCard() {
        ...
        try {
            ...
            GameState.loadDeckPersistenceAtStartup()
            assertEquals(
                listOf(PlayerDeckCard.POTION, PlayerDeckCard.KEY_BRONZE),
